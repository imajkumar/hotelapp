...
class OfferController extends Controller
{
  ...
  public function __construct()
  {
    ...
    public function index(){
      ...
      return $theme->scope('offers.index', $data)->render();
    }
    /*
    |--------------------------------------------------------------------------
    ...
    */
      ...
      public function getOffersList(Request $request){
          ...
          foreach ($offer_arr as $key => $value) {
            ...
            $data_arr[]=array(
              'RecordID' =>$value->id,
              'offer_type' =>isset($value->offer_type) ? $value->offer_type : '',
              'offer_name' =>isset($value->offer_name) ? $value->offer_name : '',
              'offer_code' => isset($value->offer_code) ? $value->offer_code : '',
              'Status' => 1,
    ...
    */
    public function store(Request $request) //v2
    {
     ...
     $user=Offer::create([
          ...
          'image' => $request->offer_img,
          'off_price' => $request->offer_amt
...
*/
    ...
    public function create()
    {
      $theme = Theme::uses('corex')->layout('layout');
      $data = ['info' => 'Hello World'];
      return $theme->scope('offers.create', $data)->render();
    }
