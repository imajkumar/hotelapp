          ...
          <div class="m-content">
              ...
              <div class="m-portlet">
                ...
                <div class="m-portlet__body">
                   <!-- form  -->
                   <!--begin::Form-->
                                     <form class="m-form m-form--state m-form--fit m-form--label-align-right" id="m_form_add_client" method="post" action="{{ route('hotel.store')}}">
                                       @csrf
                                       <div class="m-portlet__body">
                                           ...
                                           <div class="form-group m-form__group row">
                                             <div class="col-lg-4 m-form__group-sub">
                                               <label class="form-control-label">* Name:</label>
                                                 <input type="text" class="form-control m-input" name="name" placeholder="Enter Company">
                                             </div>
                                             <div class="col-lg-4 m-form__group-sub">
                                           ...
                                           <div class="form-group m-form__group row">
                                             <div class="col-lg-4 m-form__group-sub">
                                               <label class="form-control-label">* Another Name:</label>
                                                 <input type="text" class="form-control m-input" name="a_name" placeholder="Enter Other Name" >
                                             </div>
                                             <div class="col-lg-4 m-form__group-sub">
