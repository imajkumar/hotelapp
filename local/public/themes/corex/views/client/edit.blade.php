                                           ...
                                           <div class="form-group m-form__group row">
                                             <div class="col-lg-4 m-form__group-sub">
                                               <label class="form-control-label">* Name:</label>
                                                 <input type="text" value="{{$data->name}}" class="form-control m-input" name="name" placeholder="Enter Name">
                                             </div>
                                             <div class="col-lg-4 m-form__group-sub">
                                               <label class="form-control-label">Phone:</label>
                                               <input type="text" value="{{$data->phone}}" class="form-control m-input" name="phone" placeholder="Enter phone">
                                             </div>
                                             <div class="col-lg-4 m-form__group-sub">
                                               <label class="form-control-label">*Email:</label>
                                               <input type="email" value="{{$data->email}}"  class="form-control m-input" name="email" placeholder="Enter Email" >
                                             </div>
                                         ...
                                         <div class="m-form__section m-form__section--first">
                                           <div class="form-group m-form__group row">
                                             ...
                                             <div class="col-lg-4 m-form__group-sub">
                                               ...
                                               <select class="form-control m-input" id="exampleSelect1" name="status">
