										...
										<div class="m-portlet__body">
											<div class="form-group m-form__group row">
												<div class="col-lg-4">
													...
													<input type="text" id="sample_id" name="sample_id" value="{{$samples->sample_code}}" class="form-control m-input"  style="border:1px solid #c1c1;" readonly value="{{AyraHelp::getSampleIDCode()}}">
												...
												<div class="col-lg-8">
													...
													<div class="input-group m-input-group m-input-group--square">
														...
														<select class="form-control m-select2" id="m_select2_1" name="client_id">
															<option  value="{{$usersdata->id}}">{{$usersdata->firstname}} | {{$usersdata->phone}}  | {{$usersdata->email}}</option>

															@foreach ($clients as $user)

														@if ($usersdata->id==$user->id)
														@else
															<option selected ={{$usersdata->id ==$user->id ? 'selected' : ''}} value="{{$user->id}}">{{$user->firstname}} | {{$user->phone}}  | {{$user->email}}</option>
														@endif
...
<div class="form-group m-form__group row">
												<div class="col-lg-4">
													<div class="form-group m-form__group row">
														<label>Address *</label>
															<input type="text" class="form-control m-input" value="{{$samples->ship_address}}" name="client_address" placeholder="Enter Address">
															<span class="m-form__help"></span>
													</div>
												</div>
												<div class="col-lg-4">
											...
											<div class="form-group m-form__group">
												...
												<textarea class="form-control m-input" id="exampleTextarea"  name="remarks" rows="3">{{$samples->remarks}}</textarea>
											</div>
